...
*/
/*
function setButtonHistoric(name_button) {
    $('#dayHistoric').empty();
    $('#weekHistoric').empty();
    $('#monthHistoric').empty();
    $('#yearHistoric').empty();
    if(name_button=='yearly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" ng-click="test()">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartMonth()">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning active" id="day" ng-click="chartYear()">Yearly</button>');
    }
    if(name_button=='monthly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" ng-click="test()">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning active" id="day" ng-click="chartMonth()">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartYear()">Yearly</button>');   
    }
    if(name_button=='weekly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" ng-click="test()">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning active" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartMonth()">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartYear()">Yearly</button>');
    }
    if(name_button=='daily') {
        $('#dayHistoric').append('<button class="btn btn-warning active" id="day" ng-click="test()">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartMonth()">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning" id="day" ng-click="chartYear()">Yearly</button>');
    }
...
function chartHistoric(name) {
    ...
    var file_path_bar = 'http://131.251.176.109:8080/consumer/report?type=historic&graphType=barChart&time=' + time;
    var file_path_pie = 'http://131.251.176.109:8080/consumer/report?type=historic&graphType=pieChart&time=' + time;
    var label_graph = name + ' consumption';
    $.ajax({
        url: file_path_bar,
        dataType: 'jsonp',
    ...
    $.ajax({
        ...
        success: function(data_json, status){
            console.log(data_json);
            $('#DivChartPieContainer').empty();
            $('#DivChartPieContainer').append('<canvas id="pieChart" width="400" height="300">');
            var PieCanvas = document.getElementById("pieChart");
            var ctx2 = PieCanvas.getContext("2d");
            var data2 = [
                    {
...
function setButtonHistoric(name_button) {
    ...
    $('#yearHistoric').empty();
    if(name_button=='yearly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'daily\');">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'monthly\');">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning active" id="day" onclick="chartHistoric(\'yearly\');">Yearly</button>');
    }
    if(name_button=='monthly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'daily\');">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning active" id="day" onclick="chartHistoric(\'monthly\');">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'yearly\');">Yearly</button>');   
    }
    if(name_button=='weekly') {
        $('#dayHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'daily\');">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning active" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
    ...
    if(name_button=='daily') {
        $('#dayHistoric').append('<button class="btn btn-warning active" id="day" onclick="chartHistoric(\'daily\');">Daily</button>');
        $('#weekHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'weekly\');">Weekly</button>');
        $('#monthHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'monthly\');">Monthly</button>');
        $('#yearHistoric').append('<button class="btn btn-warning" id="day" onclick="chartHistoric(\'yearly\');">Yearly</button>');
    }
